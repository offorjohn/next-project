...
import { auth, logOut } from "../../lib/firebase"; // Use your initialized auth instance
...
export default function Example() {
  ...
  // Use Firebase user properties with fallback values if needed.
      ...
      */}
      <div className="min-h-full">
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <MenuButton className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none">
                        ...
                        <img alt="User avatar" src={photoURL} className="h-8 w-8 rounded-full" />
                      </MenuButton>
                    </div>
                    <MenuItems
                      transition
          ...
          <DisclosurePanel className="md:hidden">
            ...
            <div className="border-t border-gray-700 pt-4 pb-3">
              <div className="flex items-center px-5">
                <div className="shrink-0">
                  <img alt="User avatar" src={photoURL} className="h-10 w-10 rounded-full" />
                </div>
                <div className="ml-3">
        ...
        <main>
          ...
          <div className="p-4">
            <p className="text-lg font-bold">Welcome, {displayName}</p>
